...
var loggingjs = (function () { // Immediately-Invoked Function Expression (IIFE); ref: http://benalman.com/news/2010/11/immediately-invoked-function-expression/
  ...
  function logEvent(event, customName, customInfo) {
    ...
    // eventName will return the event type which is currently either mousedown (click) or keydown (typing)
    ...
    var state = location.hash; //e.g https://www.example.com/login#test will return #test
...
function sendNetworkLog(
  ...
  state,
  version) {
  var formid = "e/1FAIpQLSexs8hGh2DEKPHRnGUgqDBc2SKK20ZKaDYcsKUFvDZKOcFZlA";
  var data = {
    "entry.1230542188": uid,
    "entry.877958024": time,
    "entry.1065758420": eventname,
    "entry.1054641191": target,
    "entry.1868826717": info,
    "entry.982246947": state,
    "entry.483041235": version
  };
  var params = [];
  for (key in data) {
